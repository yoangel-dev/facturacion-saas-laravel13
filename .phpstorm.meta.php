...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/MasterCompany/Documents/Proyecto-Facturas/facturacion-saas/public/storage' => 'string',
...
'dompdf.options.enable_html5_parser','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/MasterCompany/Documents/Proyecto-Facturas/facturacion-saas/public/storage','logging.default',
...
'session.same_site','session.partitioned','session.serialization','ide-helper.filename','ide-helper.models_filename',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'dashboard','clients.index','clients.create',
'clients.store','clients.edit','clients.update','clients.destroy','invoices.index',
'invoices.create','invoices.store','invoices.show','invoices.edit','invoices.update',
'invoices.destroy','invoices.pdf','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'clients.create','clients.edit','clients.index','dashboard','invoices.create',
'invoices.edit','invoices.index','invoices.pdf','invoices.show','layouts.app',
